...
var _defaultSignUpFields = _interopRequireWildcard(require("./common/default-sign-up-fields"));
...
var SignUp = /*#__PURE__*/function (_AuthPiece) {
  ...
  function SignUp(props) {
    ...
    _this.getDefaultDialCode = _this.getDefaultDialCode.bind(_assertThisInitialized(_this));
    _this.checkCustomSignUpFields = _this.checkCustomSignUpFields.bind(_assertThisInitialized(_this));
    ...
    var _this$props$usernameA = _this.props.usernameAttributes,
        usernameAttributes = _this$props$usernameA === void 0 ? 'username' : _this$props$usernameA;

    if (usernameAttributes === 'email') {
      _this.defaultSignUpFields = _defaultSignUpFields.signUpWithEmailFields;
    } else if (usernameAttributes === 'phone_number') {
      _this.defaultSignUpFields = _defaultSignUpFields.signUpWithPhoneNumberFields;
    } else {
  ...
  _createClass(SignUp, [{
    ...
    value: function getDefaultDialCode() {
      return this.props.signUpConfig && this.props.signUpConfig.defaultCountryCode && _CountryDialCodes["default"].indexOf("+".concat(this.props.signUpConfig.defaultCountryCode)) !== -1 ? "+".concat(this.props.signUpConfig.defaultCountryCode) : '+1';
    }
  }, {
    ...
    value: function signUp() {
      ...
      if (!_awsAmplify.Auth || typeof _awsAmplify.Auth.signUp !== 'function') {
      ...
      inputKeys.forEach(function (key, index) {
        if (!['username', 'password', 'checkedValue'].includes(key)) {
          if (key !== 'phone_line_number' && key !== 'dial_code' && key !== 'error') {
            var newKey = "".concat(_this3.needPrefix(key) ? 'custom:' : '').concat(key);
      ...
      this.signUpFields.forEach(function (field) {
        if (field.label === _this3.getUsernameLabel()) {
          logger.debug("Changing the username to the value of ".concat(field.label));
    ...
    value: function showComponent(theme) {
      ...
      this.sortFields();
      return /*#__PURE__*/_react["default"].createElement(_AmplifyUI.Wrapper, null, /*#__PURE__*/_react["default"].createElement(_reactNative.ScrollView, {
        ...
        return field.key !== 'phone_number' ? /*#__PURE__*/_react["default"].createElement(_AmplifyUI.FormField, _extends({
          key: field.key,
        ...
        }, (0, _Utils.setTestId)(field.testID))) : /*#__PURE__*/_react["default"].createElement(_AmplifyUI.PhoneField, _extends({
          theme: theme,
          key: field.key,
          onChangeText: function onChangeText(text) {
      ...
      }), /*#__PURE__*/_react["default"].createElement(_AmplifyUI.AmplifyButton, _extends({
        text: _awsAmplify.I18n.get('Sign Up').toUpperCase(),
        theme: theme,
        onPress: this.signUp,
        disabled: !this.isValid()
      }, (0, _Utils.setTestId)(_AmplifyTestIDs["default"].AUTH.SIGN_UP_BUTTON)))), /*#__PURE__*/_react["default"].createElement(_reactNative.View, {
